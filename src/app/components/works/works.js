                ...
                if ((year !== undefined && year !== "") || (international !== undefined && international !== "")) {
                  return (
                    <div key={`${i}-${j}`} className="relative">
                      <div
                        className={` ${lang === 'en' ? 'leading-[1.4] mb-[0.5vh]' : 'lg:leading-[1.5] leading-[1.3] mb-[1.1vh] lg:mb-[0.3vh]'} relative flex text-[3vw] md:text-[2.4vw] lg:text-[1vw]  
                      ...
                      >
                        ...
                        <div
                          className={`${j === 1 ? `${lang === 'en' ? 'lg:mt-[0vh]' : 'lg:mt-[2vh]'}` : ''} ${
                            j === 0 ? "hidden" : ""
                          }  font-dmmono flex-[0.35] lg:pl-[22.5%] lg:text-[1vw] lg:flex-[0.1] pl-6 lg:pl-12`}
                        >
                          {year}
                        </div>
