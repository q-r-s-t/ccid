                    ...
                    return (
                      <div key={`${i}-${j}`} className="relative">
                        <div
                          ...
                          ${j === 0 && !(i === 0 && j === 0) ? `text-primaryC lg:pl-10 lg:h-[7dvh] lg:absolute lg:top-0 pl-6 lg:left-0 lg:w-[20vw]` : ""}
                          ${i === 0 && j === 0 ? 'first-item text-black lg:py-[14vh] leading-[1.1] text-[6vw] md:text-[5vw] lg:text-[3.5vw] lg:absolute lg:top-0 pl-6 lg:left-0 lg:w-[20vw]' : ''}
