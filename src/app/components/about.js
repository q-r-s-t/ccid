...
export default function About() {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full pt-10">
      <div>
        <p className="font-[500] leading-tight text-[5vw] sm:text-[4vw] lg:text-[2vw] pb-1 mb-4 border-b-[1px] md:pb-3 mb-4 xl:mb-6 2xl:mb-10 4xl:mb-20">Who We Are</p>
        <ul>
          {aboutInfo.length > 0 ? (
            aboutInfo.map((item, index) => (
              <li key={index} className="lg:flex gap-4 md:py-4 lg:py-4 mb-8 lg:mb-0 xl:mb-12">
                <div className="flex flex-col lg:flex-row gap-2 md:gap-6">
                  ...
                  {/* 한글 텍스트 */}
                  <p className="flex-[0.9] font-[500] leading-[1.8] text-[3vw] sm:text-[1.9vw] lg:text-[0.9vw] lg:ml-12 4xl:ml-28">
