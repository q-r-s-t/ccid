            ...
            aboutInfo.map((item, index) => (
              <li key={index} className="lg:flex gap-4 md:py-4 lg:py-4 mb-8 lg:mb-0 xl:mb-12">
                <div className="flex flex-col lg:flex-row gap-2 md:gap-6">
                  {/* 영문 텍스트 */}
                  <h1 className="leading-[1.3] font-semibold text-lg pb-2 flex-1 md:text-2xl lg:text-2xl lg:font-semibold lg:leading-tight xl:text-3xl xl:font-semibold 2xl:text-4xl 2xl:font-medium 3xl:text-5xl 3xl:leading-[1.2] 4xl:text-6xl 4xl:leading-[1.2]">{item[0]}</h1>
                  {/* 한글 텍스트 */}
