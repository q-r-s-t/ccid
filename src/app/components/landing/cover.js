...
export default function Cover() {
  ...
  return (
    <div className={`${programme.className} flex flex-col w-full h-full lg:pt-[38dvh] pt-[28vh] px-6 lg:px-10`}>
      {typedWords.map((word, index) => {
        ...
        return (
          <div
            key={index}
            className="text-center program_set lg:text-left relative inline-block w-full lg:h-[24vw] h-[26vw] lg:h-[3.8vw] leading-[1.1] lg:leading-[1.3] text-[7.5vw] lg:text-[3vw]"
          >
            <pre
              className={`text-black lg:hidden whitespace-pre-wrap overflow-hidden relative ${
