    ...
    <div className={`flex flex-col w-full h-full lg:pt-[38dvh] pt-[28vh] px-6 lg:px-10`}>
      {typedWords.map((word, index) => {
        ...
        return (
          ...
          >
            <pre
              className={`${programme.className} program_set text-black lg:hidden whitespace-pre-wrap overflow-hidden relative ${
            ...
            <p
              className={`${programme.className} program_set text-black hidden lg:block overflow-hidden relative ${
                index === currentWordIndex ? "after:content-['|'] after:animate-blink" : ""
              }`}
              style={colorStyle}
            >
