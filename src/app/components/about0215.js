...
export default function Aboutkeywords() {
  ...
  return (
    <div className="flex gap-[4vw] items-start justify-start w-full h-[60dvh] py-[14vh] font-[300] leading-[1.1] text-[6vw] lg:text-[3.5vw]">
      <h1 className="flex-1 leading-none text-[6vw] lg:text-[6vw] mt-[-3vh]">Who We Are</h1>
