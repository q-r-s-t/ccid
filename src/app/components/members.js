          ...
          {firstCategory[1].map((member, index) => (
            <div key={index} className="md:flex gap-8 lg:gap-6 xl:gap-[3vw]">
              ...
              <div className="md:flex-1 ">
                <h2 className="leading-[1.1] text-[3.8vw] md:text-[3vw] lg:text-[1vw]">{member[1]}</h2>
                <pre className={`${pxGrotesk.className} pt-[0.5vh] whitespace-pre-wrap leading-[1.1] text-[3.3vw] md:text-[2.1vw] lg:text-[0.6vw]`}>{member[3]}</pre>
