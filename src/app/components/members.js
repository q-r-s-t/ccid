          ...
          {firstCategory[1].map((member, index) => (
            <div key={index} className="md:flex gap-8 lg:gap-6 xl:gap-[3vw]">
              ...
              <div className="md:flex-1 ">
                <h2 className="leading-[1.3] text-[5vw] md:text-[3.3vw] lg:text-[1.3vw]">{member[1]}</h2>
                <pre className={`${pxGrotesk.className} pt-[0.5vh] whitespace-pre-wrap leading-[1.2] text-[3.45vw] md:text-[2.1vw] lg:text-[1vw]`}>{member[3]}</pre>
            ...
            {members.map((member, index) => (
              ...
              >
                ...
                <div className="flex flex-col justify-center pr-4 lg:pt-0 lg:pl-2">
                  <h3
                    className={`${pxGrotesk.className} pb-1 leading-none text-[3vw] md:text-[1.9vw] lg:text-[0.95vw]`}
                  >
                    {member[1]}
                  </h3>
                  {member[3] && (
