  ...
  return (
    <div className="pt-10">
      ...
      <ul>
        ...
        {members.labHead.map((member, index) => (
          <li key={index} className="md:flex gap-8 xl:mb-40 mb-24">
            ...
            <div className="text-sm md:flex-1 md:text-lg">
              <h2 className="text-xl md:text-3xl">{member.name}</h2>
              <a
              ...
              <p className="text-lg md:text-xl xl:2xl py-5">{member.description}</p>
              <div className="border-l pl-4 mt-4">
              <h3 className="md:pb-4 leading-none">Career</h3>
              <ol className="text-sm+ leading-relaxed">
                <li>
                  영국왕립예술대학 RCA Royal College of Art 시각커뮤니케이션전공
                  | 박사수료
                </li>
                <li>
                  로드아일랜드디자인대학 RISD Rhode Island School of Design
                  디지털+미디어 | 석사졸업
                </li>
      ...
      <ul className="mb-12 md:mb-20 xl:mb-32">
        ...
        <ul className="text-sm md:flex flex-wrap">
          {members.visitingResearcher.map((member, index) => (
            <li key={index} className="md:w-1/2 lg:w-1/3 my-2 flex gap-4 items-center xl:mb-2">
              ...
              <div className="flex flex-col justify-center pr-4">
                <h3 className="pt-5 md:pt-3 md:text-lg xl:text-xl">{member.name}</h3>
                <a
                  href={`mailto:${member.email}`}
                ...
                <p className="pb-5 xl:text-lg">{member.description}</p>
      ...
      <ul>
        ...
        <ul className="text-sm md:flex flex-wrap">
          {members.studentResearcher.map((member, index) => (
            <li key={index} className="md:w-1/2 lg:w-1/3 my-2 flex gap-4 items-center xl:mb-2">
              <img
                src={member.imageUrl}
                alt={`${member.name} profile`}
